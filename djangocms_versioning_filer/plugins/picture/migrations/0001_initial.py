# -*- coding: utf-8 -*-
# Generated by Django 1.11.16 on 2018-10-10 17:14
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cmsplugin_ptr', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, related_name='picture_versionedpicture', serialize=False, to='cms.CMSPlugin')),
                ('file_grouper', djangocms_versioning_filer.fields.image.ImageGrouperField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='djangocms_versioning_filer.FileGrouper', verbose_name='File grouper')),
