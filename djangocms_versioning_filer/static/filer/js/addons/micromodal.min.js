 ...
 * @licence     https://github.com/ghosh/Micromodal/blob/2a316150d12b3f3a0540762ee77dcb7247c6518a/LICENSE.md
 */
...
void 0===t[o]&&(t[o]=[]),t[o].push(e)}),t},a=function(e,t){if(e.length<=0)return console.warn("MicroModal v0.1.1: ❗Please specify at least one %c'micromodal-trigger'","background-color: #f8f9fa;color: #50596c;font-weight: bold;","data attribute."),console.warn("MicroModal v0.1.1: %cExample:","background-color: #f8f9fa;color: #50596c;font-weight: bold;",'<a href="#" data-micromodal-trigger="my-modal"></a>'),!1
for(var o in t)if(!document.getElementById(o))return console.warn("MicroModal v0.1.1: ❗Seems like you have missed %c'"+o+"'","background-color: #f8f9fa;color: #50596c;font-weight: bold;","ID somewhere in your code. Refer example below to resolve it."),console.warn("MicroModal v0.1.1: %cExample:","background-color: #f8f9fa;color: #50596c;font-weight: bold;",'<div class="modal" id="'+o+'"></div>'),!1
return!0}
