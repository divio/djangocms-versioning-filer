(function($) {
  ...
  $(function() {
    ...
    function toggleBurgerMenu(burgerMenuAnchor, optionsContainer) {
    ...
    function closeBurgerMenu() {
      ...
      $('.cms-filer-action-btn').removeClass('open');
      $('.cms-filer-action-btn').addClass('closed');
    }

    $('#result_list').find('tr:not(.js-filer-dropzone-folder)').each(function (index, item) {
